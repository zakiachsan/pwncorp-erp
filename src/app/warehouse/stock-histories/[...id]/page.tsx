...
const deliveryData: Record<string, any> = {
  "PD/WJY/26060041": {
    ...
    status: "RECEIVED",
    items: [
      { no: 1, sku: "0K72A-34-150FR", product: "LINK STABILIZER FR", productCode: "LK-STB-FR-001", qty: 2, price: 450000, discount: 5, amount: 855000 },
      { no: 2, sku: "0K72A-33-047FR", product: "BEARING RODA FRONT", productCode: "BRG-RD-FR-002", qty: 4, price: 325000, discount: 0, amount: 1300000 },
    ],
  },
};
  ...
  return (
    <div style={{ padding: "0 24px 24px" }}>
        ...
        <div>
          ...
          <div style={{ marginTop: 16, display: "flex", justifyContent: "flex-end" }}>
            <div style={{ width: 320 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 12px", fontSize: 13 }}>
                <span style={{ color: "#444746" }}>Tax (PPN 11%)</span>
                <span style={{ fontWeight: 600 }}>Rp {fmt(tax)}</span>
              </div>
      ...
      {activeTab === "fixedAssets" && (
        <div style={S.card}>
          <p style={{ color: "#8e8f8e", fontSize: 13, fontStyle: "italic" }}>Tidak ada fixed assets untuk delivery ini.</p>
        </div>
      )}
    </div>
  );
