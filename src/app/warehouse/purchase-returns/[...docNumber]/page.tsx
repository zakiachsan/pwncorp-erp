...
const returnData: Record<string, any> = {
  "PR/HO/26060001": {
    docNumber: "PR/HO/26060001",
    referenceNumber: "PR-2026-0001",
    purchaseInvoice: "PI/HO/26060001",
    ...
    warehouse: "Head Office - WH Main",
    notes: "Retur sparepart karena rusak saat pengiriman.",
    ...
    approvedDate: "-",
    sentDate: "-",
    journal: "JRN/HO/26060001",
    status: "DRAFT",
    items: [
      { no: 1, sku: "SKU/OL/FL/001", product: "OIL FILTER 1010A", productCode: "OL-FL-001", qty: 2, price: 125000, discount: 0, amount: 250000 },
    ],
  },
};
...
export default function PurchaseReturnDetailPage() {
  ...
  const ret = returnData[docNumber];
  ...
  return (
    <div style={{ padding: "0 24px 24px" }}>
      ...
      {activeTab === "fixedAssets" && (
        <div style={S.card}>
          <p style={{ color: "#8e8f8e", fontSize: 13, fontStyle: "italic" }}>Tidak ada fixed assets untuk return ini.</p>
        </div>
      )}
    </div>
  );
