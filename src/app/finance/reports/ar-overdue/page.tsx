...
export default function AROverduePage() {
  ...
  useEffect(() => {
    fetch("/api/reports/finance?report=ar-overdue")
      .then((r) => r.json())
      .then((j) => {
  ...
  return (
    <div>
      <div className="view-header">
        ...
        <button onClick={() => exportTableToExcel(document.querySelector(".data-table"), makeFilename("ar-overdue"))} className="btn btn--sm"><Download size={14} /> Export</button>
      </div>
