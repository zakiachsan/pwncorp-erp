...
export default function APPaymentsPage() {
  ...
  useEffect(() => {
    fetch("/api/reports/finance?report=ap-payments")
      .then((r) => r.json())
      .then((j) => {
  ...
  return (
    <div>
      <div className="view-header">
        ...
        <button onClick={() => exportTableToExcel(document.querySelector(".data-table"), makeFilename("ap-payments"))} className="btn btn--sm"><Download size={14} /> Export</button>
      </div>
