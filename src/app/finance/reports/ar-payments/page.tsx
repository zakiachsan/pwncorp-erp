...
export default function ARPaymentsPage() {
  ...
  useEffect(() => {
    fetch("/api/reports/finance?report=ar-payments")
      .then((r) => r.json())
      .then((j) => {
  ...
  return (
    <div>
      <div className="view-header">
        ...
        <button onClick={() => exportTableToExcel(document.querySelector(".data-table"), makeFilename("ar-payments"))} className="btn btn--sm"><Download size={14} /> Export</button>
      </div>
