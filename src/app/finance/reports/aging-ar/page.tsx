...
const agingData = [
  { customer: "PT Maju Jaya", total: "Rp 1.800.000", current: "Rp 1.800.000", "1-30": "-", "31-60": "-", "61-90": "-", "90+": "-" },
  { customer: "Siti Rahmawati", total: "Rp 2.600.000", current: "Rp 2.600.000", "1-30": "-", "31-60": "-", "61-90": "-", "90+": "-" },
];
    ...
    <div>
      ...
      <div className="table-wrap">
        <table className="data-table">
          ...
          <tbody>
            {agingData.map((a) => (
              <tr key={a.customer} className="hover:bg-[#f8f8f8]">
          ...
          <tfoot>
            <tr className="font-bold border-t-2 border-[--color-text-primary]">
              <td>Total</td>
              <td className="text-right">Rp 4.400.000</td>
              <td className="text-right">Rp 4.400.000</td>
