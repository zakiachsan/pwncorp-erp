...
export default function JournalCreatePage() {
  ...
  const [lines, setLines] = useState<JournalLine[]>([
    { id: 1, account: "1101", accountName: "Kas", debit: 0, credit: 0 },
    { id: 2, account: "4101", accountName: "Penjualan Produk", debit: 0, credit: 0 },
  ]);

  const addLine = () => {
    setLines([...lines, { id: Date.now(), account: "", accountName: "", debit: 0, credit: 0 }]);
  };
  ...
  return (
    <div>
      <div className="view-header">
        ...
        <button className="btn btn--brand btn--sm" disabled={!isBalanced}><Save size={14} /> Simpan</button>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="card-slds">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="form-group">
                <label className="form-label">Tipe Jurnal *</label>
              ...
              <div className="form-group sm:col-span-2">
                ...
                <textarea className="form-input" rows={2} placeholder="Deskripsi jurnal..." />
              </div>
            </div>
          </div>
            ...
            <div className="table-wrap">
              <table className="data-table">
                ...
                <tbody>
                  {lines.map((line) => (
                    <tr key={line.id}>
                      <td><input type="text" className="form-input" value={line.account} onChange={(e) => updateLine(line.id, "account", e.target.value)} style={{ width: 80 }} /></td>
                      <td><input type="text" className="form-input" value={line.accountName} onChange={(e) => updateLine(line.id, "accountName", e.target.value)} /></td>
