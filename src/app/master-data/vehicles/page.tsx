...
import { exportToCsv, parseCsv, validateRows, mapRowToApi, makeFilename, downloadTemplate, vehicleColumns } from "@/lib/csv-utils";
...
export default function VehiclesPage() {
  ...
  const handleExport = () => {
    ...
    exportToCsv(exportData, vehicleColumns, makeFilename("vehicles"));
  };
