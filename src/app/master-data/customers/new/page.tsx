  ...
  return (
    <div style={{ padding: "0 24px 24px" }}>
      ...
      <div style={{ background: "#fff", border: "1px solid #ecebea", borderRadius: 8, padding: 16 }}>
        <FInput label="NAMA" placeholder="Nama customer" />
        <FInput label="TELEPON" placeholder="No. telepon" />
        <FSelect label="TIPE" options={["Retail", "Wholesale"]} />
        <FInput label="ALAMAT" placeholder="Alamat lengkap" />
        <FInput label="EMAIL" placeholder="Email" />
        <div style={{ marginTop: 20 }}>
          <button onClick={() => { alert("Customer berhasil ditambahkan!"); router.push("/master-data/customers"); }} style={{ display: "inline-flex", alignItems: "center", gap: 5, padding: "8px 20px", fontSize: 13, fontWeight: 600, color: "#fff", background: "#0176d3", border: "1px solid #0176d3", borderRadius: 6, cursor: "pointer" }}>
            <Save size={14} /> Simpan
          </button>
        </div>
      </div>
