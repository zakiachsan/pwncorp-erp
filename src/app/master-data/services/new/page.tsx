  ...
  return (
    <div style={{ padding: "0 24px 24px" }}>
      ...
      <div style={{ background: "#fff", border: "1px solid #ecebea", borderRadius: 8, padding: 16 }}>
        <FInput label="KODE" placeholder="Contoh: J-006" />
        <FInput label="NAMA" placeholder="Nama jasa" />
        <FSelect label="KATEGORI" options={["Perawatan", "Perbaikan"]} />
        <FInput label="HARGA" placeholder="Harga jasa" />
        <FInput label="ESTIMASI WAKTU" placeholder="Contoh: 30 menit" />
        <div style={{ marginTop: 20 }}>
          <button onClick={() => { alert("Service berhasil ditambahkan!"); router.push("/master-data/services"); }} style={{ display: "inline-flex", alignItems: "center", gap: 5, padding: "8px 20px", fontSize: 13, fontWeight: 600, color: "#fff", background: "#0176d3", border: "1px solid #0176d3", borderRadius: 6, cursor: "pointer" }}>
            <Save size={14} /> Simpan
          </button>
        </div>
      </div>
