...
## Corpus Check
- 316 files · ~287,295 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1619 nodes · 2155 edges · 235 communities (149 shown, 86 thin omitted)
...
### Community 0 - "service-orders/page.tsx"
Cohesion: 0.53
...
Cohesion: 0.07
Nodes (18): GET, PUT, GET, GET, GET, DELETE, GET, PUT (+10 more)
...
Cohesion: 0.09
Nodes (14): GET, handler, GET, GET, PUT, GET, GET, GET (+6 more)
...
Cohesion: 0.18
Nodes (12): formatIDR(), PurchaseInvoicesPage(), fmtDate(), PurchaseReturnsPage(), DateRangePicker(), DateRangePickerProps, DAYS, fmtDate() (+4 more)
...
### Community 39 - "app/dashboard/page.tsx"
Cohesion: 0.16
...
Cohesion: 0.15
Nodes (9): fmtDate(), handleTypeClick(), StockHistoriesPage(), typeOptions, Sparepart, TransferRow, Option, SearchableSelect() (+1 more)
...
### Community 86 - "ar-cheque/page.tsx"
Cohesion: 0.83
...
### Community 88 - "ar-overdue/page.tsx"
Cohesion: 0.83
...
### Community 140 - "customers/[id]/route.ts"
Cohesion: 0.50
...
### Community 144 - "coa/[code]/page.tsx"
Cohesion: 0.60
Nodes (4): COADetailPage(), fmt(), fmtDate(), LedgerRow

### Community 157 - "summary-purchase-deliveries/page.tsx"
Cohesion: 0.83
...
- **Why does `withAuth()` connect `withAuth` to `numbering.ts`, `prisma.ts`, `getCurrentUser`, `customers/[id]/route.ts`, `auth-helpers.ts`, `inspection-mappings/route.ts`, `suppliers/[id]/route.ts`, `invoices/route.ts`, `users/route.ts`, `bank-accounts/route.ts`, `coa/route.ts`, `customers/route.ts`, `journal/route.ts`, `payment-requests/route.ts`, `purchase-deliveries/[id]/route.ts`, `purchase-invoices/route.ts`, `purchase-returns/[id]/route.ts`, `service-packages/route.ts`, `spareparts/route.ts`, `stock-outgoings/[id]/route.ts`, `stock-outgoings/route.ts`, `stock-returns/[id]/route.ts`, `stock-transfers/[id]/route.ts`, `stock-transfers/route.ts`, `suppliers/route.ts`, `vehicles/route.ts`, `warehouses/route.ts`, `work-orders/[id]/route.ts`, `invoices/[id]/route.ts`, `users/[id]/route.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `SearchableSelect()` connect `SearchableSelect.tsx` to `stock-workflow/stock-orders/page.tsx`, `service-orders/[...no]/page.tsx`?**
